...
struct NumericTraits<signed char>
{
    ...
    static signed char fromRealPromote(RealPromote v) {
        return ((v < 0.0) ? ((v < (RealPromote)SCHAR_MIN) ? SCHAR_MIN : static_cast<signed char>(v - 0.5)) :
...
struct NumericTraits<unsigned char>
{
    ...
    static unsigned char fromRealPromote(RealPromote const & v) {
            return ((v < 0.0) ? 0 : ((v > (RealPromote)UCHAR_MAX) ? UCHAR_MAX : static_cast<unsigned char>(v + 0.5)));
    }
};
...
struct NumericTraits<short int>
{
    ...
    static short int fromRealPromote(RealPromote v) {
        return ((v < 0.0) ?
                ((v < (RealPromote)SHRT_MIN) ? SHRT_MIN : static_cast<short int>(v - 0.5)) :
                ((v > (RealPromote)SHRT_MAX) ? SHRT_MAX : static_cast<short int>(v + 0.5)));
    }
};
...
struct NumericTraits<short unsigned int>
{
    ...
    static short unsigned int fromRealPromote(RealPromote v) {
            return ((v < 0.0) ?
              0 : ((v > (RealPromote)USHRT_MAX) ? USHRT_MAX : static_cast<short unsigned int>(v + 0.5)));
    }
};
...
struct NumericTraits<int>
{
    ...
    static int fromRealPromote(RealPromote v) {
        return ((v < 0.0) ?
                ((v < (RealPromote)INT_MIN) ? INT_MIN : static_cast<int>(v - 0.5)) :
                ((v > (RealPromote)INT_MAX) ? INT_MAX : static_cast<int>(v + 0.5)));
    }
};
...
struct NumericTraits<long>
{
    ...
    static long fromRealPromote(RealPromote v) {
        return ((v < 0.0) ?
                ((v < (RealPromote)LONG_MIN) ? LONG_MIN : static_cast<long>(v - 0.5)) :
                ((v > (RealPromote)LONG_MAX) ? LONG_MAX : static_cast<long>(v + 0.5)));
    }
};
