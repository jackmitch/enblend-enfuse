...
\newcommand*{\datebyfs}{\footnote{Date determined via file-system -- potentially unreliable.}}
\newcommand*{\datebyscm}{\footnote{Date reliable determined via source-code management system.}}
