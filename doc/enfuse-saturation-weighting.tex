...
saturation~$S_{\mathrm{HSL}}$ is computed in \acronym{HSL}~color space.  For a an introduction
to the \acronym{HSL}~color space, please consult \uref{\wikipediahslandhsv}{Wikipedia}.
