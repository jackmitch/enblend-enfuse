...
\uref{\wikipediaiccprofile}{\acronym{ICC}}-color profiles, blend color spaces in
...
is their ``weighted average''?  This is the heart of \application{Enblend's} and
\application{Enfuse's} pyramidal blending operations!  We are in particular interested in a
...
\item[\urlmark{\wikipediacieluvcolorspace}{\acronym{CIEL*u*v*}}]\itemend\urltext
  ...
  The \acronym{L*u*v*} tries to be percepually uniform
