...
by the \genidx{transform!log}\gensee{log-transform}{transform, log}Log-transform.
...
\item
  For \acronym{HDR}~data, the Log-transform puts the samples closer to a perceptual space making
