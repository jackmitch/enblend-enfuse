...
\item
  ...
  \uref{\allinoneeedersch}{original PanoTools} offers a set of command-line driven applications
  to create panoramas.  Most notable are \application{PTOptimizer} for control point
  optimization and \application{PTmender}, an image stitcher.
\end{itemize}
