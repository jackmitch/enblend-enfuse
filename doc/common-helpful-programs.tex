...
Several programs and libraries have proven helpful when working with \application{Enblend} or
\application{Enfuse}.
...
\item
  ...
  \application{Hugin}, \application{DCRaw}, \application{UFRaw}, \application{Enblend}, and
  \application{Enfuse}.  It supplies some binaries, too.  \prgidx{tificc
    \textrm{(LittleCMS)}}\command{tificc}, an \genidx{ICC@\acronym{ICC}}\acronym{ICC} color
