...
\item[--entropy-weight=\metavar{WEIGHT}]\itemend
  ...
  options~\option{--entropy-window-size} and \option{--entropy-cutoff}.
...
\item[--exposure-width=\metavar{WIDTH}]\itemend
  ...
  (option~\option{--exposure-optimum}) and vice versa.  Use this option to fine-tune exposure
  weighting (See Section~\fullref{sec:exposure-weighting}).
...
\item[--hard-mask]\itemend
  ...
  See also \sectionName~\ref{sec:fusion-options} and options~\option{--contrast-weight} as well
  as \option{--contrast-window-size} above.
