...
final result without changing the set of input images.  Option~\option{--exposure-optimum} sets
the point of optimum exposure.  Increasing the \metavar{optimum} makes \App{} prefer lighter
pixels, rendering the final image lighter, and vice versa.  Option~\option{--exposure-width}
defines the \metavar{width} of acceptable exposures.  Small values of \metavar{width} penalize
