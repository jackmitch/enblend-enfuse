...
\item[--prefer-gpu=\optional{\metavar{PLATFORM}:}\metavar{DEVICE}
  ...
  Direct \App{} towards a particular \acronym{OpenCL} \metavar{DEVICE} on the first autodetected
  \metavar{PLATFORM} or directly to the given \metavar{PLATFORM}\slash\metavar{DEVICE}
