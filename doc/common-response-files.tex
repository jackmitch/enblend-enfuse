...
beginning with a \code{\val{val:response-file-comment-char}}~sign%
...
\item[Image filenames cannot start with
  \code{\val{val:response-file-prefix-char}}]\itemend A
  \code{\val{val:response-file-prefix-char}}~sign invariably
