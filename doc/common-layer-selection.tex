...
also called ``multi-directory'' files.  \genidx[\defininglocation]{layer!image}In this manual,
...
\footnotetext{\genidx{Carter, Samantha@\propername{Maj.\ Samantha
      Carter}}\propername{Maj.\ Samantha Carter} in Lost City~II: ``There has to be a way to
  reverse the process.  The answer has to be here.''}
