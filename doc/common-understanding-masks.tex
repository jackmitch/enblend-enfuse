...
\begin{exemplar}
  ...
  \caption[Using \command{tiff\/info}.]%
          {\label{ex:using-tiffinfo}%
            ...
            interpreted as an unassociated alpha-channel; \application{Enblend} and
            \application{Enfuse} interpret this as mask.  The second hint \command{tiff\/info}
            gives is in \sample{Samples/Pixel}, where -- for a \acronym{RGB}-image -- the $4 = 3
            + 1$ tells about the extra channel.}
\end{exemplar}
