...
int process_options(int argc, char** argv) {
    ...
    static struct option long_options[] = {
        ...
        {"verbose", optional_argument, 0, IntegerArgument},              // 19
        {"help", no_argument, 0, NoArgument},                            // 20
        {"version", no_argument, 0, NoArgument},                         // 21
        {"depth", required_argument, 0, StringArgument},                 // 22
        {"output", required_argument, 0, StringArgument},                // 23
        {"SaveMasks", optional_argument, 0, StringArgument},             // 24
        {"wrap", optional_argument, 0, StringArgument},                  // 25
        {0, 0, 0, 0}
    };
